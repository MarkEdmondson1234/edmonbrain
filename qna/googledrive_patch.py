...
# OR if on GCP service to reuse existing credentals via app default:
# 3. Ensure the service account used by your GCP service has `drive.readonly` role to access the Google Drive API.
# 4. Deploy to GCP, should work for any doc your service account email has access to
import os
